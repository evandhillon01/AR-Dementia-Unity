Shader "Hidden/BlurEffectConeTap" {
	...
	half4 frag(v2f i) : SV_Target {
		...
		float currentRadius =  pow((i.uv.x - 0.5 ),2.0) + pow((i.uv.y - 0.5 ),2.0);
		float targetRadius = pow(0.125,2.0) + 0.0012 * sin(100 + (_SinTime+2)* 50 * i.uv.x) + 0.002 * sin(50 + (_CosTime+2) * 50 * i.uv.y);
